import { PackyFiles } from '../../features/packy/types';

export async function getPackyFiles(uri: string): Promise<PackyFiles> {
    if (uri) {}
    return new Promise<PackyFiles>((resolve)=>{
        resolve(INITIAL_CODE);
    });
}

const INITIAL_CODE: PackyFiles = {
    'App.js': {
